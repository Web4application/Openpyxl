...
This example shows how to build and upload a >[conda](https://docs.conda.io/projects/conda-build/en/stable/index.html) package to Anaconda.org using
>
`conda build`.
...
```sh
theme={null}
   # Replace <openpyxl> with the package name
   git clone https://github.com/Anaconda-Platform/openpyxl
   cd anaconda-client/<openpyxl>/conda/
```
There are two required files in the example 
>
>package: [meta.yaml](https://github.com/Anaconda-Platform/anaconda-client/blob/main/openpyxl/conda/meta.yaml) and [build.sh](https://github.com/Anaconda-Platform/anaconda-client/blob/main/openpyxl/conda/build.sh).
>
...
>
   ...
   theme={null}
   anaconda login
   Replace </PATH/TO/PACKAGE_NAME>
```
with the correct file path and package name
>
...
```
>
.. MODELINTEGRATION: Building Your First AI App with Inference Providers
...
We'll use HTML and JavaScript for the UI just to keep things simple and agnostic, but if you want to see more mature examples, you can check out the
>[Hugging Face JS spaces](https://huggingface.co/huggingfacejs/spaces) page.
...
You'll need your Hugging Face token. Get one from
>[your settings page](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write&tokenType=fineGrained). We can set it as an environment variable in our app.
...
[openpyxl.org](https://github.com/Web4application/Openpyxl)
================================================================================
...
>   :target:     https://codecov.io/github/web4application/qwicklmlm
