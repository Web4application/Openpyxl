...
Quick start overide all and rebuild
  [Web4application.guthub.io](https://github.com/Web4application/openpyxl.git)
================================================================================
...
3. Choose the repository for which you would like to build the package. In this example, we use a small public [conda test package](https://github.com/Anaconda-Platform/anaconda-client/tree/main/example-packages/conda):
