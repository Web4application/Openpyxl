...
<Columns cols={2}>
  ...
  <Card title="Package information" icon="box" href="/tools/anaconda-org/searching-packages#viewing-package-information.md">
    View install instructions and detailed package information on our new package detail pages
  </Card>

  <Card title="Installing packages" icon="box-arrow-down" href="/tools/anaconda-org/installing-packages.md">
...
<Columns cols={3}>
  <Card title="Organizations" icon="building" href="/tools/anaconda-org/admin-guide/organizations.html">
    Create and manage an organization
  </Card>

  <Card title="Groups" icon="users" href="/tools/anaconda-org/admin-guide/groups.html">
...
<Columns cols={3}>
  <Card title="Get started" icon="party-horn" href="/tools/anaconda-org/maintainer-guide/getting-started.md">
    Use your Anaconda account to start your package maintainer journey
  </Card>

  <Card title="Upload packages" icon="boxes-stacked" href="/tools/anaconda-org/maintainer-guide/upload-packages.md">
    Upload your own conda and standard Python packages for public use
  </Card>

  <Card title="Maintain packages" icon="hammer" href="/tools/anaconda-org/maintainer-guide/hosted-packages.md">
